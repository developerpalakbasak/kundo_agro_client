  ...
  return (
    <div className="hidden items-center gap-5 md:flex">
      ...
      <button
        ...
        className="cursor-pointer rounded-lg border border-gray-200 px-3 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:border-emerald-600 hover:text-emerald-600"
      >
        {t("logout") || "Logout"}
      </button>
    </div>
