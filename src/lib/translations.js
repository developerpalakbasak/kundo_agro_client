export const translations = {
  en: {
    ...
    sellerRegisterTitle: "Hatchery & Seller Registration",
    sellerRegisterSubtitle: "Create a hatchery account to list your fish seeds and agro products.",
    registerAsSeller: "Register as Seller",
    alreadyHaveSellerAccount: "Already have a seller account?",
    noSellerAccount: "Don't have a seller account yet?",
    pendingApprovalBanner: "Account Pending Admin Approval",
    pendingApprovalDesc: "Your hatchery account is under review by our administration. You can add and manage your products now; they will become publicly visible once approved.",
    verifiedSeller: "Verified Hatchery",
    unverifiedSeller: "Pending Verification",
    manageProducts: "Manage Products",
    totalRevenue: "Total Revenue",
    ordersList: "Orders & Inquiries",
  ...
  bn: {
    ...
    sellerRegisterTitle: "হ্যাচারি ও বিক্রেতা নিবন্ধন",
    sellerRegisterSubtitle: "মাছের পোনা ও এগ্রো পণ্য বিক্রির জন্য হ্যাচারি অ্যাকাউন্ট তৈরি করুন।",
    registerAsSeller: "বিক্রেতা হিসেবে নিবন্ধন করুন",
    alreadyHaveSellerAccount: "ইতিমধ্যে একটি বিক্রেতা অ্যাকাউন্ট আছে?",
    noSellerAccount: "এখনো বিক্রেতা অ্যাকাউন্ট নেই?",
    pendingApprovalBanner: "অ্যাকাউন্টটি অ্যাডমিন অনুমোদনের অপেক্ষায় রয়েছে",
    pendingApprovalDesc: "আপনার হ্যাচারি অ্যাকাউন্টটি অ্যাডমিনের পর্যালোচনায় রয়েছে। আপনি পণ্য যোগ করতে পারেন; অ্যাকাউন্ট অনুমোদিত হলে তা প্রকাশ্যে প্রদর্শিত হবে।",
    verifiedSeller: "অনুমোদিত হ্যাচারি",
    unverifiedSeller: "অনুমোদনের অপেক্ষায়",
    manageProducts: "পণ্য পরিচালনা",
    totalRevenue: "মোট আয়",
    ordersList: "অর্ডার ও ইনকোয়ারি সমূহ",
